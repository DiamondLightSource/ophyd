...
.. _GitHub: https://github.com/DiamondLightSource/ophyd/issues
...
To get the source source code and run the unit tests, run::
    ...
    $ git clone git://github.com/DiamondLightSource/ophyd.git
    $ cd ophyd
    $ pipenv install --dev
    $ pipenv run tests
...
.. _release: https://github.com/DiamondLightSource/ophyd/releases
...
latest version of the skeleton, run::
    ...
    $ git pull https://github.com/DiamondLightSource/dls-python3-skeleton skeleton
...
<https://github.com/DiamondLightSource/dls-python3-skeleton/pulls?q=is%3Apr+is%3Aclosed>`_
of the skeleton module for more details.

.. _dls-python3-skeleton: https://DiamondLightSource.github.io/dls-python3-skeleton
